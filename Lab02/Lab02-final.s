numOfValues 	EQU 	4 ; define the num of values to be averaged
...
__main PROC
			...
			ldrb R1, [R0], #1			; load 1st element to R1, and post-increment pointer

addloop		ldrb R2, [R0], #1			; load next element to R2, and post-increment pointer
